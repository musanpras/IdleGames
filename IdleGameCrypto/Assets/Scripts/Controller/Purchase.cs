...
//please implement "IStoreListener" like "public class Purchase : MonoBehaviour, IStoreListener" to remove errors
public class Purchase : MonoBehaviour,IStoreListener
{
	...
	public static Purchase Instance { get { return _instance; } }


	void Awake()
	{
		if (FindObjectsOfType(typeof(Purchase)).Length > 1)
		{
			Destroy(gameObject);
			return;
		}
